...
|:----:|:----:|:----:|:------------:|:--------:|:--------------:|
| ![Docker Pulls](https://img.shields.io/docker/pulls/johann8/alpine-glpi?logo=docker&label=pulls&style=flat-square&color=blue) | [![GLPI Version](https://img.shields.io/badge/GLPI%20version-10.0.25-orange.svg?style=flat-square)](https://www.glpi-project.org/en/) | ![Docker Image Size (latest by date)](https://img.shields.io/docker/image-size/johann8/alpine-glpi/latest?logo=docker&style=flat-square&color=blue&sort=semver) | [![Docker Image](https://img.shields.io/docker/v/johann8/alpine-glpi/latest?logo=docker&style=flat-square&color=blue&sort=semver)](https://hub.docker.com/r/johann8/alpine-glpi/tags "Version badge") | ![Platform](https://img.shields.io/badge/platform-amd64-blue "Platform badge") | [![Alpine Version](https://img.shields.io/badge/Alpine%20version-v3.22.0-blue.svg?style=flat-square)](https://alpinelinux.org/) |

<h2 align="center">Docker Image Alpine 3.23</h2>

| Pull | GLPI | Size | Docker Image | Platform | Alpine version |
|:----:|:----:|:----:|:------------:|:--------:|:--------------:|
| ![Docker Pulls](https://img.shields.io/docker/pulls/johann8/alpinei3.23-glpi?logo=docker&label=pulls&style=flat-square&color=blue) | [![GLPI Version](https://img.shields.io/badge/GLPI%20version-10.0.25-orange.svg?style=flat-square)](https://www.glpi-project.org/en/) | ![Docker Image Size (latest by date)](https://img.shields.io/docker/image-size/johann8/alpine3.23-glpi/latest?logo=docker&style=flat-square&color=blue&sort=semver) | [![Docker Image](https://img.shields.io/docker/v/johann8/alpine3.23-glpi/latest?logo=docker&style=flat-square&color=blue&sort=semver)](https://hub.docker.com/r/johann8/alpine3.23-glpi/tags "Version badge") | ![Platform](https://img.shields.io/badge/platform-amd64-blue "Platform badge") | [![Alpine Version](https://img.shields.io/badge/Alpine%20version-v3.23.0-blue.svg?style=flat-square)](https://alpinelinux.org/) |

<h2 align="center">Docker Image Alpine 3.24</h2>

| Pull | GLPI | Size | Docker Image | Platform | Alpine version |
|:----:|:----:|:----:|:------------:|:--------:|:--------------:|
| ![Docker Pulls](https://img.shields.io/docker/pulls/johann8/alpine3.24-glpi?logo=docker&label=pulls&style=flat-square&color=blue) | [![GLPI Version](https://img.shields.io/badge/GLPI%20version-10.0.25-orange.svg?style=flat-square)](https://www.glpi3.24-project.org/en/) | ![Docker Image Size (latest by date)](https://img.shields.io/docker/image-size/johann8/alpine3.24-glpi/latest?logo=docker&style=flat-square&color=blue&sort=semver) | [![Docker Image](https://img.shields.io/docker/v/johann8/alpine3.24-glpi/latest?logo=docker&style=flat-square&color=blue&sort=semver)](https://hub.docker.com/r/johann8/alpine3.24-glpi/tags "Version badge") | ![Platform](https://img.shields.io/badge/platform-amd64-blue "Platform badge") | [![Alpine Version](https://img.shields.io/badge/Alpine%20version-v3.24.0-blue.svg?style=flat-square)](https://alpinelinux.org/) |
